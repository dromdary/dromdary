...
public class CommonPropertiesHelper {
	...
	public static String PROPERTY_NOT_JPA_CLASS = "not.entity.class";
	...
	public static String implHierarchy() throws FileNotFoundException,
			IOException {
		Properties properties = new Properties();
		properties.load(new FileInputStream(COMMON_PROPERTIES_PATH));
	...
	public static String generateNotEntity() throws FileNotFoundException,
			IOException {
		Properties properties = new Properties();
		properties.load(new FileInputStream(COMMON_PROPERTIES_PATH));
		return properties.getProperty(PROPERTY_NOT_JPA_CLASS);
	}
